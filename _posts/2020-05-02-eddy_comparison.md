...
而中纬度气旋的**发生频率高，形状和结构多变，不对称，水平尺寸从100-1000km不等，移动速度多变**。加上热带外气旋经常会发生**合并和分离**，使得气旋的追踪变得复杂化。此外，气旋发生的**天气环境也是多变的**。中纬度气旋的这些特点使得现在对气旋没有一个统一的定义，也使得气旋追踪的方法多样。
...
设定的标准是气旋的生命史不短于24h，同时还有一个网站并提供了14种追踪方法计算得到的气旋数据。

根据对气旋的不同理解，常用海平面气压和底层大气相对涡度来辨认和追踪气旋。  
其中**涡度**与风场有关，包含更多高频信息；**海平面气压**与质量场有关，更多反映低频尺度信号。此外，基于涡度的方法可以辨认处于早期阶段的气旋，此时他们还没有形成闭合等压线（最小气压中心没有出现）。  
...
https://naturwissenschaften.ch/organisations/proclim/activities/project_imilast

https://naturwissenschaften.ch/organisations/proclim/activities/project_imilast/data_download
