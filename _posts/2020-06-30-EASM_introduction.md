...
该研究认为**地形驱动的定常波为途径TP的西风带核下游北风响应提供了一个可能的动力联系**。在中纬度，大气对地形强迫的线性响应表现为定常Rossby波的向赤道传播和山体下游底层气旋性运动的产生。因此，该文将中国东北地区北风的变化归因于TP下游气旋性环流强度的变化，认为急流移动到TP北部的现象减弱了地形强迫，从而减弱气旋性环流，导致下游北风的减弱甚至消失。
